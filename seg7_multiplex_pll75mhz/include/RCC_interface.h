...
#define RCC_APB_PRESCALER_HCLK_DIV1  0
#define RCC_APB_PRESCALER_HCLK_DIV2  4
#define RCC_APB_PRESCALER_HCLK_DIV4  5
#define RCC_APB_PRESCALER_HCLK_DIV8  6
#define RCC_APB_PRESCALER_HCLK_DIV16 7
...
void RCC_setBusPrescaler(u8 bus, u8 value);
