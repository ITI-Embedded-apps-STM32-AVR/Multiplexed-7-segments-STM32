...
/* this should be set to the current (actual) value of SysClk,
...
void delay_ms(u32 time)
{
	 ...
	 * - 3.44us is the time of epilogue
	 * - 1.5us is the time of each iteration
	...
	const u32 ctr = (u32)((((f64)time * (f64)1000.0 - (f64)189.0 - (f64)3.44) * (f64)(CPU_CLOCK)) / ((f64)8000000.0 * (f64)1.5));
...
void delay_us(u32 time)
{
	...
	const u32 ctr = (u32)((((f64)time - (f64)189.0 - (f64)3.44) * (f64)(CPU_CLOCK)) / ((f64)8000000.0 * (f64)1.5));
